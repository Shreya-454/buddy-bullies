...
const Footer = () => {
  return (
      <div>
          <footer className='footer-bg  bg-blue2 pt-100 pb-5'>
              <div className='container pb-4'>
                  <h3 className='text-white text-center ff-poppins fs-xl fw-semibold'>JOIN US</h3>
                  <div className='row pt-100 align-items-center'>
                      <div className='col-12  col-md-6 col-lg-6'>
                          <h4 className='text-white ff-poppins fs-2lg'>LOGO</h4>
                          <p className='text-white ff-poppins fs-xs opacity-60 max-w388'>Aenean arcu sed rhoncus sapien euismod cursus morbi lacus, blandit. Placerat tortor
                      ...
                      <div className='col-12  col-md-6 col-lg-6 pt-5'>
                          <div className='row'>
                              <div className='col-6'>
                                  <ul className='ps-0'>
                                      <li className='text-white ff-poppins fw-medium fs-xs'>Resources</li>
                                      <li><a href="#Roadmap" className='text-white ff-poppins fs-xs'>Roadmap</a></li>
                                      <li><a href="#Faq" className=' text-white ff-poppins fs-xs'>FAQs</a></li>
                                      <li><a href="#minting" className='text-white ff-poppins fs-xs'>Mint your Bully</a></li>
                                  </ul>
                              </div>
                              <div className='col-6 '>
                                  <h4 className='text-white ff-poppins fs-xs fw-medium'>Community</h4>
                                  <div className='d-flex gap-3'>
                                      <div className='icon2' ><a href="https://www.instagram.com/">
                                      ...
                                      <div className='icon2'><a href="https://twitter.com/">
                                      ...
                                      <div className='icon2'><a href="https://discord.com/">
                  ...
                  <p className='mb-0'><a href="" className=' text-white ff-poppins fs-xs'>Email@gmail.com</a></p>
              </div>
